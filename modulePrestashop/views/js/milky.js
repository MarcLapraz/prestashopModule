		...
		$.ajax({
			...
			success : function(data){
				...
				if (data == "false"){		
					...
					var link = 'https://chez-smoke-cigarette-electronique.ch/Backoffice/index.php?controller=AdminCustomers&id_customer='+numero+'&viewcustomer&token=f6fefe9c12ebde04be6c342c09e3b5c8';
					$("#link").attr("href", link);
